...
module.exports = ({ columns, district, header, partner, partnerUtils }) => {
  const csvReadPath = utils.getReadPath({ district, partner });
  fs.readFile(csvReadPath, 'utf8', (err, rawText) => {
    ...
    const normalizedData = partnerUtils.normalizeData({ columns, data });
